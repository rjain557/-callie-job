...
- 2026-04-17: MISS: Sent Callie a Crate and Barrel "Design Consultant - Elevate Homes In-Store" kit. User flagged: C&B is mass-market retail, even though the role has "Design Consultant" in the title. NEW RULE for tomorrow's scan: distinguish luxury-branded showrooms (RH, Waterworks, Natuzzi, Visual Comfort, Ethan Allen, Mitchell Gold+Bob Williams, Arhaus) — OK, from mass-market retailer design-consultant titles (Crate and Barrel, Williams-Sonoma "Home Design Consultant", Pottery Barn, West Elm, Home Depot, Lowes, Ashley Furniture, Living Spaces, Bob's Discount) — SKIP these, they're retail regardless of title. The tell: if the role is "in-store" at a chain with 100+ locations selling to walk-in consumers, it's retail. Kept #33 for now per user but add these to hard exclusions tomorrow.
